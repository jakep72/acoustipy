...
# layer1 = structure.Add_JCA_Layer(thickness = 30, flow_resistivity = 25000, porosity = .93, tortuosity = 2.3, viscous_characteristic_length = 80, thermal_characteristic_length = 105)
...
# ml = AcousticID(mount_type='No Gap',no_gap_file="no_gap.csv")

# res = ml.ML(30)
# stats = ml.stats(res)
# print(stats)
# ml.plot_comparison(res)
